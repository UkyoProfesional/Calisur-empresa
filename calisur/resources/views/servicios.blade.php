...
<div class="container py-8 mx-auto">
    <div class="flex flex-wrap items-center">
        ...
        <h2 class="mb-4 text-4xl font-bold text-[#360A13]">REUBICACION Y MANTENIMIENTO DE BOMBAS CONTRA INCENDIO</h2>
            <h3 class="mb-4 text-2xl underline text-[#360A13]">Ingenieria:</h3>           
            <ul>
            ...
            <br>
            <h3 class="mb-4 text-2xl underline text-[#360A13]">Obra mecánica:</h3>           
            <ul>
                <li>Cálculo hidráulico</li>
                <li>Redistribución de tuberías</li>
                <li>Protocolo de Izaje</li>
            ...
            <br>
            <h3 class="mb-4 text-2xl underline text-[#360A13]">Obra eléctrica:</h3>           
            <ul>
            ...
            <br>
            <h3 class="mb-4 text-2xl underline text-[#360A13]">Obra civil:</h3>           
            <ul>
...
<div class="container py-8 mx-auto">
    <div class="flex flex-wrap items-center">
        ...
        <h2 class="mb-4 text-4xl font-bold text-[#360A13]">Transporte de residuos peligrosos</h2>
            <ul>
                <ol>Traslado de residuos peligrosos mediante</ol>
                <ol>Translado de crudo</ol>
                <ol>Disposición final de residuos peligrosos</ol>
                <ol>Confinamiento de residuos peligrosos</ol>
            </ul>
        </div>
    </div>
</div>
