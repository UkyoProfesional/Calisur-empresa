...
<div class="flex justify-around flex-wrap">
    ...
    <div class="max-w-xs mx-4 my-8 bg-white p-6 rounded-lg text-center">
      <img src="img/imagen7.png" alt="Descripción de la imagen 1" class="w-full h-auto rounded-md mb-4">
      <p class="text-[#360A13]">Conceptos básicos sobre protección ambiental.</p>
    </div>

    <div class="max-w-xs mx-4 my-8 bg-white p-6 rounded-lg text-center">
      <img src="img/imagen8.jpeg" alt="Descripción de la imagen 2" class="w-full h-auto rounded-md mb-4">
      <p class="text-[#360A13]">Clasificación y uso de equipos de protección respiratoria.</p>
    </div>

    <div class="max-w-xs mx-4 my-8 bg-white p-6 rounded-lg text-center">
      <img src="img/imagen9.jpeg" alt="Descripción de la imagen 2" class="w-full h-auto rounded-md mb-16">
      <p class="text-[#360A13]">Básico de seguridad</p>
    </div>

    <div class="max-w-xs mx-4 my-8 bg-white p-6 rounded-lg text-center">
      <img src="img/imagen10.png" alt="Descripción de la imagen 2" class="w-full h-auto rounded-md mb-4">
    ...
    <div class="max-w-xs mx-4 my-8 bg-white p-6 rounded-lg text-center">
      <img src="img/imagen12.png" alt="Descripción de la imagen 2" class="w-full h-auto rounded-md mb-4">
